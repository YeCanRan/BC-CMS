...
{
    public partial class FormOvernightPrice : Form
    {
        ArrayList PriceList = new ArrayList();
        int i = 0;
        public FormOvernightPrice()
        {
            InitializeComponent();
            try
            {
                ...
                SqlCommand PriceChange = new SqlCommand("select * from ViewPrice where Class='过夜'", GlobalClass.Connection);

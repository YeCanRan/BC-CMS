...
{
    public partial class FormBathPrice : Form
    {
        ArrayList PriceList = new ArrayList();
        int i = 0;
        public FormBathPrice()
        {
            InitializeComponent();
            try
            {
                ...
                SqlCommand PriceChange = new SqlCommand("select * from ViewPrice where Class='搓澡'", GlobalClass.Connection);

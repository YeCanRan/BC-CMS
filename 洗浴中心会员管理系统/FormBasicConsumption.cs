...
{
    public partial class FormBasicConsumption : Form
    {
        ArrayList PriceList = new ArrayList();
        int i = 0;
        public FormBasicConsumption()
        {
            InitializeComponent();
            try
            {
                ...
                SqlCommand PriceChange = new SqlCommand("select * from ViewPrice where Class='基础消费'", GlobalClass.Connection);
